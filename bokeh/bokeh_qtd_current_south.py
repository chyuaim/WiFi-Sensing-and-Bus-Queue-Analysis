...
df = get_qtd_south_df(COLLECTION_CURRENT_91M,COLLECTION_CURRENT_11,COLLECTION_CURRENT_104,COLLECTION_CURRENT_91P)

df_boarded = get_qtd_south_df(COLLECTION_BOARDED_91M,COLLECTION_BOARDED_11,COLLECTION_BOARDED_104,COLLECTION_BOARDED_91P) 

y_upper = sync_y_upper(df,df_boarded,0)
...
def callback():
    ...
    y_upper = sync_y_upper(df,df_boarded,y_upper)
